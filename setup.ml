...
(* OASIS_START *)
(* DO NOT EDIT (digest: 51c9e571c609d0ba25d0f589a362b49f) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./linking.native", []))];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Eventchn_dummy"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xen_evtchn";
                      lib_findlib_name = Some "unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "xen_evtchn_unix_activations";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Unix_activations"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xen_evtchn_unix";
                      lib_findlib_name = Some "activations";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\169.\136\1550\255\189\193s\173\127\018\147,\202]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
